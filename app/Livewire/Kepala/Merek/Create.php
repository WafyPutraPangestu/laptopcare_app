...
class Create extends Component
{
    ...
    {
        return [
            'nama_merek'       => 'required|string|max:100|unique:merek_laptop,nama_merek',
    ...
    public function save(): void
    {
        ...
        session()->flash('success', "Merek \"{$this->nama_merek}\" berhasil ditambahkan.");
        $this->redirect(route('kepala.merek.index'), navigate: true);
    }

    public function render()
    {
        return view('livewire.kepala.merek.create');
    }
}
